...
// Adicionado 'streak' às propriedades recebidas
export default function Home({ setActiveNav, streak = 26}) {
  return (
    <>
      <style>{`
        * {
        ...
        <div className="cards-row">
          ...
          <div className="main-panel-left">
            ...
            <div className="ladder-card">
              ...
              {/* Mudança aqui: renderizando o valor da prop 'streak' */}
              <h2 className="ladder-title">🔥 {streak} DIAS DE OFENSIVA</h2>
